document.addEventListener('DOMContentLoaded', () => {
      ...
      document.getElementById('btn-consultar')?.addEventListener('click', () => {
        document.querySelector('.nav-link[href="#equipment-report"]')?.click();
      });
      ...
      links.forEach(link => {
        link.addEventListener('click', e => {
          ...
          if (target) {
            ...
            if (!targetSection && (target === 'equipment-report' || target === 'equipment-history')) {
              // If target is a tab, navigate to consulta section
              targetSection = document.getElementById('consulta');
              // Set hash for tab switching
