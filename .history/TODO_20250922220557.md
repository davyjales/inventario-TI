# TODO - Implementação Separação Snapshot vs Changed Fields
...
### 🔄 EM ANDAMENTO:
- [ ] Adicionar coluna `snapshot` na tabela `equipment_history`
...
- Adicionar coluna `snapshot` TEXT na tabela `equipment_history`
- Manter coluna `changed_fields` para compatibilidade
