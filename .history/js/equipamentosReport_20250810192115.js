    ...
    equipamentosBody.querySelectorAll('.btn-edit').forEach(button => {
      button.addEventListener('click', async () => {
        ...
        try {
          ...
          document.getElementById('edit-equipment-id').value = equipamento.id || '';
          document.getElementById('edit-categoria').value = equipamento.categoria_id || '';
          ...
          document.getElementById('edit-cargo').value = equipamento.cargo || '';
          document.getElementById('edit-descricao').value = equipamento.descricao || '';
          document.getElementById('edit-status').value = equipamento.status_id || '';
