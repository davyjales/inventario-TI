...
function renderEquipmentDetails(equipamento) {
    ...
    <div class="detail-section">
      ...
      <div class="field-group">
        ...
        <div class="field-item">
          ...
          <div class="field-value">${equipamento.descricao || 'Não informado'}</div>
        </div>
        <div class="field-item">
          <div class="field-label">Status:</div>
          <div class="field-value">${equipamento.status || 'Não informado'}</div>
        </div>
      </div>
    </div>
  `;
  ...
  // TODO: Render additionalFields if needed
}
