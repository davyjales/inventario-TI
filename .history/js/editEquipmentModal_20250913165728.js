export async function abrirModalEditarEquipamento(id) {
  ...
  if (cancelBtn) {
    // Remove event listeners antigos (caso abra várias vezes o modal)
    cancelBtn.replaceWith(cancelBtn.cloneNode(true));
    const newCancelBtn = document.getElementById('cancel-edit');

    newCancelBtn.addEventListener('click', (e) => {
      e.preventDefault(); // impede comportamento padrão de botão dentro do form
  ...
  if (editForm) {
    ...
    const newEditForm = document.getElementById('edit-equipment-form');
