...
module.exports = {
  async listarHistorico(req, res) {
    try {
      const { equipmentNameFilter, equipmentUserFilter, equipmentQrcodeFilter, adminUserFilter, actionFilter, startDate, endDate } = req.query;
        ...
        try {
          ...
          if (record.action === 'update') {
            ...
            for (const [key, value] of Object.entries(changedFields)) {
              ...
              } else if (value && typeof value === 'object' && value.campo) {
                // Se já tem campo definido, usar como está
                enrichedChanges[key] = value;
              } else {
                // Para outros casos, manter o valor original
                enrichedChanges[key] = value;
              }
            }
