...
module.exports = {
  ...
  async criarEquipamento(req, res) {
    const { categoria_id, nome, dono, setor, descricao, hostname, status_id, additionalFields } = req.body;
    ...
    try {
      ...
      const [result] = await connection.query(
        `INSERT INTO equipamentos 
         (categoria_id, nome, dono, setor, descricao, termo, qrCode, hostname, status_id) 
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [categoria_id, nome, dono, setor, descricao, termo, identificador, hostname || null, status_id || 1]
      );
