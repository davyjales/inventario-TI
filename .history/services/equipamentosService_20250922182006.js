 ...
 async listarEquipamentos(req, res) {
  ...
  async atualizarEquipamento(req, res) {
    ...
    try {
      ...
      // Log para update do equipamento - fazer ANTES da alteração
      ...
      // --- LOG: usar cloneEquipmentToHistory para snapshot completo ---
      await cloneEquipmentToHistory(connection, id, 'update', userId);

      // --- LOG: usar logEquipmentChange para filtrar apenas mudanças reais ---
